...
export class MyApp {
  ...
  onboardingPage: any = OnboardingPage;
  ...
  openProfile(user_id) {
    this.nav.push(this.profilePage, {user: user_id})
  }
  ...
  openFriends() {
    this.nav.push(this.mainPage,{user: this.user, tabIndex: "1"});
    this.closeSubItems();
  }
  openMessages(){
    this.nav.push(this.mainPage,{user: this.user, tabIndex: "2"});
    this.closeSubItems();
  }
