...
export class User
{
  ...
  constructor( public http: Http, public authHttp: AuthHttp, public routesProvider: Routes )
  {
  ...
  setRoutes( host )
  {
    ...
    this.photo_url = host + "photos";
  }
  getAdsWithStartingId( ad_id )
  {
    return this.authHttp.get( this.get_ads_with_starting_id_url + ad_id + ".json" ).map( res => res.json() );
  }
  open_my_notifications( user_id )
  {
    return this.authHttp.get( this.open_my_notifications_url + ".json" ).map( res => res.json() );
  }
  load_interests( user_id )
  {
    return this.authHttp.get( this.load_interests_url + user_id + ".json" ).map( res => res.json() );
  }
  is_member_of( group )
  {
    return this.authHttp.get( this.is_member_of_url + group.id + ".json" ).map( res => res.json() );
  }
  send_request_to( group )
  {
    return this.authHttp.get( this.send_request_to_url + group.id + ".json" ).map( res => res.json() );
  }
  i_was_invited_to( group )
  {
    return this.authHttp.get( this.i_was_invited_to_url + group.id + ".json" ).map( res => res.json() );
    // this.comments_url = this.host + "comments/";
  }
  get_notification_by_id( user_id, notification_id )
  {
    return this.authHttp.get( this.comments_url + notification_id + ".json" ).map( res => res.json() );
  }
  open_all_user_notifications( user_id )
  {
    return this.authHttp.get( this.open_all_user_notifications_url + user_id + ".json" ).map( res => res.json() );
  }
  ...
  get_all_notifications( user_id )
  {
    return this.authHttp.get( this.my_notifications_url + ".json" ).map( res => res.json() );
  }
  get_nautical_sports_by_user( user_id )
  {
    return this.authHttp.get( this.get_nautical_sports_by_user_url + "/" + user_id + ".json" ).map( res => res.json() );
  }
  update_user_nautical_sports( user_id, userNauticalSports )
  {
    return this.authHttp.put( this.update_user_nautical_sports_url + "/" + user_id + ".json",
    {
      'user_nautical_sports': userNauticalSports
    } ).map( res => res.json() );
  }
  update_user_interests( user_id, userInterests )
  {
    return this.authHttp.put( this.update_user_interests_url + "/" + user_id + ".json",
    {
  ...
  {
    return this.authHttp.get( this.get_interests_by_user_url + "/" + user_id + ".json" ).map( res => res.json() );
  }
  get_interests()
  {
    return this.authHttp.get( this.interests_url + ".json" ).map( res => res.json() );
  }
  ...
  {
    return this.authHttp.put( this.user_album_url + "/" + albumPhoto.id + ".json",
    {
  ...
  add_photos_to_album( album_id, photos_array )
  {
    ...
    console.log( param );
    return this.authHttp.post( path, param ).map( res => res.json() );
  }
  get_user_album( user_id )
  {
    return this.authHttp.get( this.get_user_album_url + user_id + ".json" ).map( res => res.json() );
  }
  //gu
  get_albums( user_id )
  {
    return this.authHttp.get( this.get_albums_url + user_id ).map( res => res.json() );
  }
  //gu
  get_album_photos( album_id )
  {
    console.log( "get_album_photos >> album_id = " + album_id )
    return this.authHttp.get( this.get_album_photos_url + album_id ).map( res => res.json() );
  }
  //gu
  ...
  edit_album( album )
  {
    ...
    return this.authHttp.put( url, param ).map( res => res.json() );
  }

  //gu
  delete_photo( photo_id )
  {
    return this.authHttp.delete( this.photo_url + "/" + photo_id + ".json" ).map( res => res.json() );
  }

  destroy_user_album_photo( photo_id )
  {
    return this.authHttp.delete( this.user_album_url + "/" + photo_id + ".json" ).map( res => res.json() );
  }
  load_nautical_sports()
  {
    return this.authHttp.get( this.load_nautical_sports_url + ".json" ).map( res => res.json() );
  }
  load_state_for_travels()
  {
    return this.authHttp.get( this.load_state_for_travels_url + ".json" ).map( res => res.json() );
  }
  load_country_for_travels()
  {
    return this.authHttp.get( this.load_country_for_travels_url + ".json" ).map( res => res.json() );
  }
  getUser( user_id )
  {
    return this.authHttp.get( this.url + "/" + user_id + ".json" ).map( res => res.json() );
  }
  create( user )
  {
  ...
  update( user )
  {
    return this.authHttp.put( this.url + ".json",
    {
      'user': user
    } ).map( res =>
    {
  ...
  delete()
  {
    return this.authHttp.delete( this.url + ".json" ).map( res => res.json() );
  }
  // Session sign_up : (post)users.json
  login( user )
  {
    return this.http.post( this.url + "/sign_in.json",
    {
      'user': user
    } ).map( res => res.json() );
  }
  logout()
  {
    return this.authHttp.delete( this.url + "/sign_out.json" ).map( res => res.json() );
  }
  event_friends( event )
  {
    return this.authHttp.get( this.event_friends_url + event + ".json" ).map( res => res.json() );
  }
  group_friends( group )
  {
    return this.authHttp.get( this.group_friends_url + group + ".json" ).map( res => res.json() );
  }
  myEvents( current_user )
  {
    return this.authHttp.get( this.my_events_url + current_user.id + ".json" ).map( res => res.json() );
  }
  confirmedEvents( current_user )
  {
    return this.authHttp.get( this.confirmed_events_url + current_user.id + ".json" ).map( res => res.json() );
  }
  pendingEvents( current_user )
  {
    return this.authHttp.get( this.pending_events_url + current_user.id + ".json" ).map( res => res.json() );
  }
  accept_event( event )
  {
  ...
  {
    return this.authHttp.put( this.refuse_event_url + event.id + ".json",
    {
      'event': event.id
    } ).map( res => res.json() );
  }
  ...
  {
    return this.authHttp.get( this.my_groups_url + ".json" ).map( res => res.json() );
  }
  allGroups()
  {
    return this.authHttp.get( this.all_groups_url + ".json" ).map( res => res.json() );
  }
  confirmedGroups( current_user )
  {
    return this.authHttp.get( this.confirmed_groups_url + ".json" ).map( res => res.json() );
  }
  pendingGroups( current_user )
  {
    return this.authHttp.get( this.pending_groups_url + ".json" ).map( res => res.json() );
  }
  accept_group( current_user, group )
  {
    return this.authHttp.put( this.accept_group_url + ".json",
    {
      'group': group.id
    } ).map( res => res.json() );
  }
  ...
  {
    return this.authHttp.put( this.refuse_group_url + ".json",
    {
      'group': group.id
    } ).map( res => res.json() );
  }
  save_avatar( user )
  {
    ...
    return this.authHttp.put( this.url + "/" + user.id + "/" + "save_avatar.json",
    {
      'avatar':
      {
        'image': user.avatar,
  ...
  save_cover_photo( user )
  {
    let d = new Date;
    let new_name = user.id + d.getTime();
    return this.authHttp.put( this.url + "/" + user.id + "/" + "save_cover_photo.json",
    {
      'cover_photo':
      {
  ...
  {
    return this.authHttp.get( this.user_advertiser_url + current_user.id + ".json" ).map( res => res.json() );
  }
  user_friends( user )
  {
    return this.authHttp.get( this.user_friends_url + user.id + ".json" ).map( res => res.json() );
  }
  accept_friendship( user )
  {
    return this.authHttp.get( this.accept_friendship_url + user.id + ".json" ).map( res => res.json() );
  }
  refuse_friendship( user )
  {
    return this.authHttp.get( this.refuse_friendship_url + user.id + ".json" ).map( res => res.json() );
  }
  request_friendship( user )
  {
    return this.authHttp.get( this.request_friendship_url + user.id + ".json" ).map( res => res.json() );
  }
  is_friend_of( user )
  {
    return this.authHttp.get( this.is_friend_of_url + user.id + ".json" ).map( res => res.json() );
  }
  pending_friendships()
  {
    return this.authHttp.get( this.pending_friendships_url + ".json" ).map( res => res.json() );
  }
  unfriend( user )
  {
    return this.authHttp.get( this.unfriend_url + user.id + ".json" ).map( res => res.json() );
  }
  user_list()
  {
    return this.authHttp.get( this.url + ".json" ).map( res => res.json() );
  }
  forgot_password( user )
  {
    return this.authHttp.post( this.password_url + ".json", user ).map( res => res.json() );
  }
  get_devise_token()
  {
    return this.authHttp.get( this.devise_token_url + ".json" ).map( res => res.json() );
  }
  update_password( user )
  {
    return this.authHttp.put( this.update_password_url + ".json", user ).map( res => res.json() );
  }
  ...
  {
    return this.http.post( this.omniauth_callback_url,
    {
      cordova: btoa( JSON.stringify( auth ) )
    } ).map( res => res.json() );
  }
}